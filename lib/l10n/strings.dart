...
const Map<String, String> _en = {
  ...
  'large.scan': 'Scan',
  'large.untouched': 'Last changed',
  'large.anyAge': 'Any time',
  'large.months3': 'Over 3 months ago',
  'large.months6': 'Over 6 months ago',
  'large.year1': 'Over a year ago',
  'large.years2': 'Over 2 years ago',
...
const Map<String, String> _ko = {
  ...
  'large.minSize': '최소 크기',
  'large.scan': '검사',
  'large.untouched': '마지막 수정',
  'large.anyAge': '전체',
  'large.months3': '3개월 이상 지남',
  'large.months6': '6개월 이상 지남',
  'large.year1': '1년 이상 지남',
  'large.years2': '2년 이상 지남',
...
const Map<String, String> _ja = {
  ...
  'large.minSize': '最小サイズ',
  'large.scan': 'スキャン',
  'large.untouched': '最終更新',
  'large.anyAge': 'すべて',
  'large.months3': '3 か月以上前',
  'large.months6': '6 か月以上前',
  'large.year1': '1 年以上前',
  'large.years2': '2 年以上前',
...
const Map<String, String> _zh = {
  ...
  'large.minSize': '最小大小',
  'large.scan': '扫描',
  'large.untouched': '最后修改',
  'large.anyAge': '全部',
  'large.months3': '3 个月以前',
  'large.months6': '6 个月以前',
  'large.year1': '1 年以前',
  'large.years2': '2 年以前',
